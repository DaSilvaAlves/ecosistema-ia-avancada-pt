...
- [x] **P0.1** `npm audit fix` em `v2/` — Next.js 15.5.15 → 15.5.19, high resolvido. **PR #65** (12/06/2026), gates locais 4/4 PASS (typecheck, 1582/1582 vitest, build, audit). Criticals da cadeia `request` (node-telegram-bot-api) + 12 moderate ficam decididos no Epic 6.
