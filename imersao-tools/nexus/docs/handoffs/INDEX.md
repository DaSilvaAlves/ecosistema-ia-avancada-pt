...
|---------|-----|------|------|--------------|
| [RETOMA-20260508-story-1.9-ready-for-review-aguarda-devops-push.md](RETOMA-20260508-story-1.9-ready-for-review-aguarda-devops-push.md) | `@dev` | `@devops` | 08/05/2026 | `@devops *push` (branch `feat/nexus-v2-story-1.9-ui-chat-consumer` → PR contra main) |
