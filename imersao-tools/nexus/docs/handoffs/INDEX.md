...
|---------|-----|------|------|--------------|
| [RETOMA-20260508-story-1.9-pr-12-iter2-fixes-aplicados-aguarda-cr-iter2.md](RETOMA-20260508-story-1.9-pr-12-iter2-fixes-aplicados-aguarda-cr-iter2.md) | `@dev` | `@devops` | 08/05/2026 | `@devops *push` — push 6 commits Iter 2 (HEAD `46969755`) e aguarda CR Iter 2 (hard-stop policy: Iter 3 PROIBIDA sem aprovação Eurico) |
