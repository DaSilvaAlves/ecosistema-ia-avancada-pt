...
**Story 2.9 CLOSED MERGED 18/05/2026** — Vista projecto (FR31) entregue em main. Epic 2 a **7/10 Done**. Pendentes: 2.6, 2.7, 2.10.

Sequência sugerida:

```text
@sm *draft 2.10 (Tools cérebro tarefas/projectos — desbloqueada por 2.1+2.8, integra com Epic 1)
  ‖ paralelizável com:
@sm *draft 2.6 (Sistema de tags global — independente, FR14)
@sm *draft 2.7 (Motor de recorrência — independente, FR10)
```

Stories 2.6, 2.7 e 2.10 podem ser draftadas em paralelo em 3 branches distintas — todas independentes entre si após 2.9 estar em main.
