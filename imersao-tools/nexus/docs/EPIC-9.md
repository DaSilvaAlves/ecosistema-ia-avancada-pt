...
> **Estado: Epic 9 EM CURSO — 9.11 DONE (01/07/2026) + 9.1a DONE (03/07/2026, PR #102 `b21bb0c2`).** Resta 9.1b (finanças) para completar a unidade de âmbito 9.1, mais 9.2-9.10. Último epic do roadmap PRD §9. **Não bloqueia nenhum epic** (coluna "Bloqueia" vazia). Critério de fecho: **11/11 stories Done** — a unidade 9.1 lê-se como "9.1a **e** 9.1b Done" (ver nota de numeração em §5) — com CI bloqueante activo (9.8), PWA instalável verificada (AC3), backup/restore round-trip validado (AC4/AC5), deploy contínuo automatizado (9.10, NFR19) e o full-suite determinístico (9.11, já feito). Com o Epic 9 fechado, o Nexus v2 está **production-ready** e o roadmap MVP (PRD §9) fica completo. Próximo passo: **9.1a mergeada desbloqueia 9.1b** → `@dev *develop 9.1b` (finanças; allowlist empacotado com os testes, SF-1/SF-2). Em paralelo, 9.2 (E2E) é independente. As stories de deploy/CI (9.8/9.10) continuam a exigir a resolução das incógnitas de estado de produção (a)/(b) abaixo.
