...
| 4.3 | Heatmap calendário | Heatmap estilo GitHub contributions por hábito, últimos 6 meses. **Componente com múltiplos estados de render → teste de componente obrigatório (`react-component-test-criteria.md`)** | FR26 | `@ux-design-expert` | `@dev` | **Ready** (29/05 — `docs/stories/active/4.3.story.md`; PO Validation GO 10/10 High `PO-VALIDATION-STORY-4.3.md`; aguarda `@ux-design-expert *develop 4.3`) |
