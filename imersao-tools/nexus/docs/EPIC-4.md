...
> **Estado:** EM CURSO — 8/10 stories Done (4.1 schema/DAL, 4.2 CRUD hábitos, 4.3 heatmap calendário, 4.4 métricas por hábito, 4.5 CRUD metas, 4.6 CRUD lembretes, 4.7 setup Web Push, 4.10 tools cérebro). Restam só 2 de Web Push: 4.8 (agendamento), 4.9 (SW handler) — ambas destrancadas pela infra da 4.7 (PR #54 merged `25d1c780`).
